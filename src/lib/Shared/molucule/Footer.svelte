...
<nav class="mobile-nav">
	<ul>
		<li >
			<button href="/" class:active={navSelect === 'home'} onclick={() => (goto('/'))}>
		...
		<li>
			<button href="/transactions" class:active={navSelect === 'transactions'} onclick={() => (goto('/transactions'))}>
		...
		<li>
			<button href="/stock-overview" class:active={navSelect === 'stock'} onclick={() => (goto('/stock-overview'))}>
		...
		<li>
			<button href="/how-it-works" class:active={navSelect === 'how-it-works'} onclick={() => (goto('/how-it-works'))}>
		...
		<li>
			<button href="/inbox" class:active={navSelect === 'inbox'} onclick={() => (goto('/inbox'))}>
