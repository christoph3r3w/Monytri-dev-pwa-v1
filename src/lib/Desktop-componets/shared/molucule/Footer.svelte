...
<nav class="mobile-nav">
	<ul>
		<li >
			<!-- <button href="/" class:active={navSelect === 'home'} onclick={() => (navSelect = 'home')}> -->
		...
		<li>
			<!-- <button href="/transactions" class:active={navSelect === 'transactions'} onclick={() => (navSelect = 'transactions')}> -->
		...
		<li>
			<!-- <button href="/stock-overview" class:active={navSelect === 'stock'} onclick={() => (navSelect = 'stock')}> -->
		...
		<li>
			<!-- <button href="/how-it-works" class:active={navSelect === 'how-it-works'} onclick={() => (navSelect = 'how-it-works')}> -->
		...
		<li>
			<!-- <button href="/inbox" class:active={navSelect === 'inbox'} onclick={() => (navSelect = 'inbox')}> -->
